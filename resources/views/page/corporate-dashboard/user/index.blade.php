...
@section('page-link', route('corporate.user.index'))
@section('page-title', 'Data')
@section('sub-page-title', 'User')

@section('content')
    <x-util.card title="User" add url="{{route('corporate.user.create')}}">
...
<x-datatables.single url="{{route('corporate.user.index')}}">
